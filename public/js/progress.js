...
// let sketch3 = function(p5) {
//     let canvasTotals;

//     let nutritionBadges = [];
//     let reflectionBadges = [];
...
//     function preload() {
//     // Load SVG files into the arrays
//     for (let i = 0; i < numbers.length; i++) {
//         let path = `resources/progress/${nutritionSVGs[i]}${numbers[i]}.svg`;
//         nutritionBadges.push(loadImage(path));
//         console.log(path);
//     }
//     for (let i = 0; i < numbers.length; i++) {
//         let path = `resources/progress/${reflectionSVGs[i]}${numbers[i]}.svg`;
//         reflectionBadges.push(loadImage(path));
//     }
// }
...
//         let containerTotals = document.getElementById("totalContainer");

//         // Get the width and height of the container
//         let containerWidth = containerTotals.offsetWidth;
//         let containerHeight = containerTotals.offsetHeight;

//         // Create a canvas with the same size as the container
//         canvasTotals = p5.createCanvas(containerWidth, containerHeight); 

//         // Move the canvas inside the container
//         canvasTotals.parent('totalContainer');
//         preload();
...
//     p5.draw = function() {
//         // totalBadges(canvasTotals, totalStreaks);
//         console.log(nutritionBadges.length);
//     }
...
//     window.addEventListener('resize', function() {
//         let containerTotals = document.getElementById("totalContainer");
//         p5.setCanvasSize(containerTotals.offsetWidth, containerTotals.offsetHeight);
//     });

// }
// //     // function  totalBadges(canvas, array){
// //     //     let width = canvas.width;
// //     //     let height = canvas.height;


// //     //     let bufferX = width * 0.1;
// //     //     let bufferY = height * 0.1;

// //     //     let innerWidth = width - bufferX;
// //     //     let innerHeight = height - bufferY;

// //     //     let titleHeight = height * 0.28;
// //     //     let rowsHeight = innerHeight - titleHeight;

// //     //     let rowHeight = rowsHeight / 2;

// //     //     let badges = array.length;
...
// //     // // Logic for drawing and creating the day streak badges 
// //     // function totalBadges(canvas, values) {

// //     //     // buffer is 1% of the canvas, on each side of the badge
// //     //     let buffer = canvas.width * 0.1;

// //     //     // badge slot is a square that will contain the badge
// //     //     let slot = canvas.width / values.length;

// //     //     // badge area is the horizontal area the badge will occupy
// //     //     let badgeArea = slot - 2 * buffer;
...
// //     //         p5.push();
// //     //         let xPos = buffer + (slot * i) + badgeRadius; // Calculate the x-position of the ellipse center
// //     //         p5.ellipse(xPos, yPos, badgeArea * 2);

// //     //         p5.textAlign(p5.CENTER, p5.CENTER); // Align text to the center of the ellipse
// //     //         p5.textSize(slot * 0.4); // Adjust text size

// //     //         // Draw the streak day letter at the center of the ellipse
// //     //         p5.fill(255); // Set text color to white
// //     //         p5.text(values[i], xPos, yPos);
// //     //         p5.pop();
// //     //     }
// //     // }
